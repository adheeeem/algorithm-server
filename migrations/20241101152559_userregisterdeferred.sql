...
alter table app_user_enrollment add constraint app_user_enrollment_app_user_id_fkey foreign key (app_user_id) references app_user(id) deferrable initially deferred;
-- +goose StatementEnd
